...
/***/ function(module, exports, __webpack_require__) {
	...
	var _head = __webpack_require__(1);
	...
	var _organization = __webpack_require__(24);
	...
	var _vueStore = __webpack_require__(19);

	var _vueStore2 = _interopRequireDefault(_vueStore);

	var _meta = __webpack_require__(20);
	...
	exports.default = {
	  ...
	  install: function install(Vue) {
	    ...
	    _lodash2.default.merge(_head2.default._seo_opts, options, {
	      policies: {
	        breadcrumbs: _store.policies.identity
	      }
	    });
	    Vue.component('head', _head2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _headDisplayer = __webpack_require__(6);
	...
	exports.default = {
	  ...
	  methods: {
	    policyForKey: function policyForKey(key) {
	      if (_lodash2.default.has(options, 'policies') && _lodash2.default.has(options.policies, key)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var warnKeyChange = function warnKeyChange() {
	  if (typeof listener === 'function') {
	    listener(_lodash2.default.keys(store));
	  }
	};

	var firstPolicy = exports.firstPolicy = function firstPolicy(data) {
	  return _lodash2.default.first(data).value;
	};

	var lastPolicy = function lastPolicy(data) {
	  return _lodash2.default.last(data).value;
	};
	...
	var joinPolicy = function joinPolicy(separator) {
	  ...
	  return function (data) {
	    var pre = (0, _lodash2.default)(data).map('value');
	    var rev = reversed ? pre.reverse() : pre;
	...
	var get = exports.get = function get(key) {
	  ...
	  if (_lodash2.default.has(store, key) && store[key].length > 0) {
	...
	var set = exports.set = function set(id, key, value) {
	  ...
	  var found = _lodash2.default.find(store[key], { id: id });
	  if (found) {
	    found.value = value;
	  } else {
	...
	var remove = exports.remove = function remove(id, key) {
	  if (_lodash2.default.has(store, key)) {
	    _lodash2.default.remove(store[key], { id: id });
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var supportedDisplayers = [_breadcrumbs2.default, _title2.default, _meta2.default, emptyComponent];
	...
	exports.default = {
	  ...
	  data: function data() {
	    ...
	    this.component = _vueStore2.default.Vue.extend(_lodash2.default.find(supportedDisplayers, function (_ref) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storeAccess = __webpack_require__(10);

	var _storeAccess2 = _interopRequireDefault(_storeAccess);

	var _jsonldWriter = __webpack_require__(11);
	  ...
	  methods: {
	    convert: function convert() {
	      return {
	        ...
	        "@type": "BreadcrumbList",
	        "itemListElement": _lodash2.default.map(this.value, function (val, index) {
	  ...
	  computed: {
	    content: function content() {
	      ...
	      if (this.contacts && this.contacts.length > 0) {
	        data.contactPoint = _lodash2.default.map(this.contacts, function (contact) {
